...
namespace StudentPortal.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
           ...
           // var user = new ApplicationUser { Email = model.Email, FirstName = model.FirstName, LastName = model.LastName, UserName = model.FirstName + ' ' + model.LastName };
            ...
            switch (result)
            {
                case SignInStatus.Success:
                    return RedirectToLocal("/Home/Courses");
        ...
        public async Task<ActionResult> Register(RegisterViewModel model)
        {
            if (ModelState.IsValid)
            {
                var count = ApplicationDbContext.Users.Count();
                var studentId = Utility.GenerateId(count + 1);
                var user = new ApplicationUser { StudentId = studentId, Email = model.Email, FirstName = model.FirstName, LastName = model.LastName, UserName = model.Email };
        ...
        public ActionResult EditProfile(Profile model)
        {
            ...
            var user = ApplicationDbContext.Set<ApplicationUser>().Find(id);
